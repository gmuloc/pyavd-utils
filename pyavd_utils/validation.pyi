...
class ValidationStoreNotInitializedError(PyAVDUtilsValidationError): ...
class ValidationStoreAlreadyInitializedError(PyAVDUtilsValidationError): ...
class ValidationStoreLoadError(PyAVDUtilsValidationError): ...
class ValidationStoreLoadJsonError(ValidationStoreLoadError): ...
class ValidationStoreLoadYamlError(ValidationStoreLoadError): ...
class ValidationStoreLoadIoError(ValidationStoreLoadError): ...
class ValidationStoreInvalidExtensionError(ValidationStoreLoadError): ...
class ValidationStoreNoFilesFoundError(ValidationStoreLoadError): ...
class ValidationSchemaResolveError(PyAVDUtilsValidationError): ...
class ValidationSchemaTypeError(ValidationSchemaResolveError): ...
class ValidationRefSyntaxError(ValidationSchemaResolveError): ...
class ValidationSchemaPathError(ValidationSchemaResolveError): ...
class ValidationSchemaStoreError(PyAVDUtilsValidationError): ...
class ValidationInvalidSchemaNameError(ValidationSchemaStoreError): ...
class ValidationSchemaWalkError(ValidationSchemaResolveError): ...
class ValidationInvalidJsonDataError(PyAVDUtilsValidationError): ...
class ValidationInvalidAdhocSchemaJsonError(PyAVDUtilsValidationError): ...
class ValidationInvalidCoercedDataJsonError(PyAVDUtilsValidationError): ...
class ValidationInternalError(PyAVDUtilsValidationError): ...
...
def init_store_from_file(file: Path) -> None:
    ...
    Raises:
        ValidationStoreLoadError: For issues hit during loading or deserializing schemas.
        ValidationSchemaResolveError: For issues hit while resolving schemas.
